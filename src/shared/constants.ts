...
export const TEXTURE_EFFECTS: TextureEffect[] = [
  {
    ...
    promptModifier: 'TEXTURE DOMINANT: severely burnt and charred, blackened edges consuming 30% of frame, scorch marks eating into the image, fire-ravaged photograph pulled from ashes, singed corners curling inward, smoke damage obscuring details, ember glow visible in damaged areas',
  },
  {
    id: 'melted',
    name: 'Melted',
    ...
    promptModifier: 'TEXTURE DOMINANT: aggressively melting and liquifying, emulsion dripping off the frame, heat-warped beyond recognition in places, photograph left on a radiator for days, colors bleeding and pooling, plastic-melt distortion, face/subject partially dissolved',
  },
  {
    id: 'glitched-edges',
    name: 'Glitch Edge',
    ...
    promptModifier: 'TEXTURE DOMINANT: severely corrupted digital frame, pixel explosion at borders, RGB channel separation bleeding inward, scan line errors consuming edges, data rot spreading from corners, frame buffer completely destroyed, artifacts overtaking 40% of image',
  },
  {
    id: 'kaleidoscope',
    name: 'Kaleidoscope',
    ...
    promptModifier: 'TEXTURE DOMINANT: extreme kaleidoscopic fragmentation, subject shattered into 12+ mirrored segments, prismatic rainbow refractions, reality fractured through crystal lens, symmetrical chaos, identity multiplied and distorted, psychedelic mirror maze effect',
  },
  {
    id: 'water-damaged',
    name: 'Water Damage',
    ...
    promptModifier: 'TEXTURE DOMINANT: severely water-damaged, extensive tide marks and mineral deposits, paper buckled and warped from flooding, colors bled and faded, mold spots visible, photograph recovered from flood waters, 50% of image obscured by water damage',
  },
  {
    id: 'torn',
    name: 'Torn',
    ...
    promptModifier: 'TEXTURE DOMINANT: violently torn and ripped, jagged tears cutting through the subject, layers peeling away revealing void beneath, collage reconstruction from fragments, missing chunks, aggressive paper destruction, held together by nothing',
  },
  {
    id: 'double-exposure',
    name: 'Double Exp',
    ...
    promptModifier: 'TEXTURE DOMINANT: extreme double exposure collision, two realities fighting for dominance, ghosted secondary image at 70% opacity, film accident creating identity confusion, overlapping exposures creating new impossible subject, neither image fully visible',
  },
  {
    id: 'light-leak',
    name: 'Light Leak',
    ...
    promptModifier: 'TEXTURE DOMINANT: catastrophic light leak, orange and magenta flares consuming 40% of frame, fogged film destroying shadow detail, accidental exposure burning out highlights, light bleeding aggressively across subject, camera back opened mid-shot',
  },
  {
    id: 'scratched',
    name: 'Scratched',
    ...
    promptModifier: 'TEXTURE DOMINANT: heavily scratched and gouged, deep grooves cut through emulsion, decades of abuse visible, surface damage obscuring subject, dust and debris embedded in scratches, film dragged across concrete, physical violence to the medium',
  },
  {
    id: 'noise-grain',
    name: 'Heavy Grain',
    ...
    promptModifier: 'TEXTURE DOMINANT: extreme film grain overpowering detail, ISO 12800+ pushed film, grain clumps visible as texture, image dissolving into noise, analog static consuming fine detail, sandpaper texture across entire frame, barely recognizable through grain',
  },
  {
    id: 'solarized',
    name: 'Solarized',
    ...
    promptModifier: 'TEXTURE DOMINANT: extreme Sabattier solarization, tones completely inverted in midrange, psychedelic color shifts, darkroom accident pushed to maximum, reality reversed, silver halide rebellion, what was dark is light, alien color palette',
  },
  {
    id: 'xerox',
    name: 'Xerox',
    ...
    promptModifier: 'TEXTURE DOMINANT: 15th generation photocopy, toner smeared and streaked, high contrast destroying midtones, paper texture visible, copy of a copy of a copy degradation, office machine artifact aesthetic, barely legible through reproduction decay',
  },
];
