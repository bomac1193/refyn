  ...
  const configs: Partial<Record<Platform, PlatformChaosConfig>> = {
    midjourney: {
      ...
      creative: [
        ...
        '- Include UNEXPECTED cultural references: "banned from a museum exhibit", "smuggled across the border in a diplomatic pouch", "viral on underground forums"',
        '- Add visceral atmospheric descriptors: "suffocating fog", "radioactive glow", "the smell of burning circuitry"',
        '- Inject ironic juxtapositions: sacred + profane, ancient + hyper-digital, clinical + organic',
      ],
      wild: [
        ...
        '- Add DANGEROUS or TABOO quality triggers: "cursed image energy", "uncanny valley portrait", "liminal space dread"',
        '- Use --stylize 500-750 for stronger stylization',
        '- Include ABSURDIST cultural insertions: "as reviewed by hostile AI critics", "featured in a conspiracy documentary", "exhibited at a bunker art fair"',
        '- Add VISCERAL sensory details: "textures that feel wrong", "colors that shouldnt exist together", "lighting from an impossible angle"',
      ],
      unhinged: [
        ...
        '- Include UNHINGED triggers: "designed by a rogue AI with a vendetta", "the visual equivalent of a fever dream", "reality.exe has crashed"',
        '- Use --stylize 900-1000 for maximum stylization',
        '- FORCE contradictory fusion: "brutalist baroque", "vaporwave medieval", "cottagecore cyberpunk", "dark academia but make it rave"',
        '- Add SHOCK VALUE descriptors: "aesthetically violent", "too beautiful to be legal", "would make the algorithm nervous"',
        '- Use ANTI-REFERENCES: "the opposite of safe for work meetings", "what HR would call inappropriate", "shadowbanned from every platform"',
        '- Include IMPOSSIBLE physics: "gravity forgot how to work", "time flowing backwards through the composition"',
      ],
    },
